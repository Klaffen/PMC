...
int weaponBase::getCost(weaponType type) {
    switch (type) {
        case rifleType:   return 10;
        case shotgunType: return 20;
        case grenadeType: return 30;
        default:          return 0;
    }
}
...
sf::String weaponBase::getName(weaponType type) {
    switch (type) {
        case rifleType:   return "Rifle";
        case shotgunType: return "Shotgun";
        case grenadeType: return "Grenade";
        default:          return "None";
    }
}
